...
def tdd_renew_foward_out_foward():
    ...
    if (len(learning_input.shape)>1):
        ...
        #learning_input_tmp = learning_input.reshape(learning_input.shape[0],40,80);
        learning_input_tmp = learning_input_tmp[-1]
    else:
        learning_input_tmp = learning_input.reshape(180,16);
        #learning_input_tmp = learning_input.reshape(40,80);
    ...
    #foward_input_tmp = foward_input.reshape(40,80);
