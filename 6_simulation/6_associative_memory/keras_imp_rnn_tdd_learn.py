...
def tdd_learn(args1):
    ...
    learning_input_tmp = text_input.reshape(text_input.shape[0],180,16);
    #learning_input_tmp = text_input.reshape(text_input.shape[0],40,80);
    ...
    #    SimpleRNN(units=16, activation="tanh", input_shape=(4, 16)), #sigmoid #tanh!!!
        SimpleRNN(units=80, activation="tanh", input_shape=(180, 16)), #sigmoid #tanh!!!
    #    SimpleRNN(units=80, activation="tanh", input_shape=(40, 80)), #sigmoid #tanh!!!
