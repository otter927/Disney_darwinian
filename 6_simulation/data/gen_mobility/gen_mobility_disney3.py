...
f = open("data/position_disney_12montue_senario.csv", 'w')
writer = csv.writer(f)
...
#uenum_array = np.loadtxt('data/uenum_20220914_repeat_satsun6_mon1.txt')
#uenum_array = np.loadtxt('data/uenum_satsun_senario.txt')
uenum_array = np.loadtxt('data/uenum_12montue_senario.txt')
#uenum_array = np.loadtxt('data/uenum_23tuewed_senario.txt')
#uenum_array = np.loadtxt('data/uenum_34wedthu_senario.txt')
#uenum_array = np.loadtxt('data/uenum_45thufri_senario.txt')
#uenum_array = np.loadtxt('data/uenum_56frisat_senario.txt')
#uenum_array = np.loadtxt('data/uenum_halfyear_senario.txt')
