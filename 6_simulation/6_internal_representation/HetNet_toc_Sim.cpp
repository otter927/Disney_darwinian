...
double Simulator::execute_sim_supervised_evaluation(vector<double> &position_list, vector<vector<double>> &foward_list, vector<vector<vector<double>>> & sinr_map_all, FILE *fi, vector<FILE *>fo_list, int file_num_tmp, int ps_id_x){
...
double Simulator::execute_sim_dqn_evaluation(vector<double> &position_list, vector<vector<double>> &foward_list, vector<vector<vector<double>>> & sinr_map_all, FILE *fi, FILE *fr, vector<FILE *>fo_list, int file_num_tmp, int ps_id_x){

    double reward;
    reward = execute_sim_supervised_evaluation(position_list, foward_list, sinr_map_all, fi, fo_list, file_num_tmp, ps_id_x);
