...
g++ -Wall -O0 -o out_learn -I /home/lu/Documents/Disney_darwinian/cppflow-master/include HetNet_toc_supervised.cpp HetNet_toc_BS.cpp HetNet_toc_UE.cpp HetNet_toc_Link.cpp HetNet_toc_Sim.cpp HetNet_toc_func.cpp darwinian_rbm_rap.cpp -ltensorflow
