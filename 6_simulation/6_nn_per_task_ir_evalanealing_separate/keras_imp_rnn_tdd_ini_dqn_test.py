...
#                    dict(type='dense', size=16*40, activation='tanh')]
    network_spec = [dict(type='dense', size=16*40, activation='tanh'),
                    dict(type='dense', size=16*40, activation='tanh')]
#    network_spec = [dict(type='dense', size=16*40, activation='leaky-relu'),
#                    dict(type='dense', size=8*40, activation='leaky-relu'),
#                    dict(type='dense', size=4*40, activation='tanh')]
