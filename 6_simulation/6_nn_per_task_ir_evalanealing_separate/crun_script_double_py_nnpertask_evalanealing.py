...
#    for i in range(k, k+2):
    for i in range(k, k+100):
        ...
        print("./out_learn_dqn "+str(alpha)+" "+str(i)+" "+str(gene)+" "+str(data_size)+" "+str(best_nn)+" >> scr_output_learn.txt")
        os.system("./out_learn_dqn "+str(alpha)+" "+str(i)+" "+str(gene)+" "+str(data_size)+" "+str(best_nn)+" >> scr_output_learn.txt")
