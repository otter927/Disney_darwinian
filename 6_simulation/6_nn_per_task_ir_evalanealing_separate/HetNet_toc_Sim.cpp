...
double Simulator::execute_sim_supervised_evaluation(vector<double> &position_list, vector<vector<double>> &foward_list, vector<vector<vector<double>>> & sinr_map_all, FILE *fi, vector<FILE *>fo_list, int file_num_tmp, vector<float> &wr, vector<float> &wroutput_vector, int ps_id_x, int best_nn){
...
double Simulator::execute_sim_dqn_evaluation(vector<double> &position_list, vector<vector<double>> &foward_list, vector<vector<vector<double>>> & sinr_map_all, FILE *fi, FILE *fr, FILE *fro, vector<FILE *>fo_list, int file_num_tmp, int ps_id_x, int best_nn){

    double reward;
    vector<float> wr(NN);
    vector<float> wroutput_vector(N*NN);
    reward = execute_sim_supervised_evaluation(position_list, foward_list, sinr_map_all, fi, fo_list, file_num_tmp, wr, wroutput_vector, ps_id_x, int best_nn);
