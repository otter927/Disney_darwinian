...
class Simulator
{
  ...
  double capacity_calculation3(vector<vector<vector<double>>> & sinr_map_all, int write_flag);
  ...
  double execute_sim_supervised_evaluation(vector<double> &position_list, vector<vector<double>> &foward_list, vector<vector<vector<double>>> & sinr_map_all, FILE *fi, vector<FILE *>fo, int file_num_tmp, vector<float> &wr, vector<float> &wroutput_vector, int ps_id_x, int best_nn);
  double execute_sim_dqn_evaluation(vector<double> &position_list, vector<vector<double>> &foward_list, vector<vector<vector<double>>> & sinr_map_all, FILE *fi, FILE *fr, FILE *fro, vector<FILE *>fo_list, int file_num_tmp, int ps_id_x, int best_nn);
