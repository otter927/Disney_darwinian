...
#define __PYX_HAVE__hetnet__hello
#define __PYX_HAVE_API__hetnet__hello
/* Early includes */
#ifdef _OPENMP
#include <omp.h>
#endif /* _OPENMP */
...
/* Module declarations from 'hetnet.hello' */
#define __Pyx_MODULE_NAME "hetnet.hello"
extern int __pyx_module_is_main_hetnet__hello;
int __pyx_module_is_main_hetnet__hello = 0;

/* Implementation of 'hetnet.hello' */
...
if (!__Pyx_RefNanny) {
  ...
  #endif
  if (__pyx_module_is_main_hetnet__hello) {
    if (PyObject_SetAttr(__pyx_m, __pyx_n_s_name, __pyx_n_s_main) < 0) __PYX_ERR(0, 1, __pyx_L1_error)
  }
  #if PY_MAJOR_VERSION >= 3
  {
    PyObject *modules = PyImport_GetModuleDict(); if (unlikely(!modules)) __PYX_ERR(0, 1, __pyx_L1_error)
    if (!PyDict_GetItemString(modules, "hetnet.hello")) {
      if (unlikely(PyDict_SetItemString(modules, "hetnet.hello", __pyx_m) < 0)) __PYX_ERR(0, 1, __pyx_L1_error)
    }
  }
  #endif
  /*--- Builtin init code ---*/
 ...
 */
  ...
  if (__pyx_m) {
    if (__pyx_d) {
      __Pyx_AddTraceback("init hetnet.hello", __pyx_clineno, __pyx_lineno, __pyx_filename);
    }
    Py_CLEAR(__pyx_m);
  } else if (!PyErr_Occurred()) {
    PyErr_SetString(PyExc_ImportError, "init hetnet.hello");
  }
  __pyx_L0:;
  __Pyx_RefNannyFinishContext();
  #if CYTHON_PEP489_MULTI_PHASE_INIT
...
static int __Pyx_main(int argc, wchar_t **argv) {
    ...
    {
      PyObject* m = NULL;
      __pyx_module_is_main_hetnet__hello = 1;
      #if PY_MAJOR_VERSION < 3
          inithello();
