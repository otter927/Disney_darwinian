...
from . import darwinian_meta_rapper as dw
...
#        )
    ...
    def sim_set_state_darwinian(self, config, x):
        ##print("config:"+str(config)+"id:"+str(self.id)+"index:"+str(self.id*10+x))
...
#            env = env + 1        
    ...
    def sim_darwinian_init_set_action(self, t):
        #print("sim_darwinianA")
        self.Deme = dw.PyDeme()
        #print("sim_darwinianB")
        self.Deme.py_evolution_initialization(t)
        #print("sim_darwinianC")
        self.NN_num = self.Deme.get_NN()
        
        #print("sim_darwinianD")
        self.Deme.py_evolution_gen_environment(t)
        #print("sim_darwinianE")
        self.Deme.py_test_versatility(t)
        deme_list = self.Deme.py_evolution_gen_update(t)	
        #print("sim_darwinianF")
        #py_evolution_gen_calcfitness(t)
        return(deme_list)
...
#######################
    def execute_sim_darwinian(self, position_list):
        ...
        #print("deme_list shape:"+str(type(deme_list)))
