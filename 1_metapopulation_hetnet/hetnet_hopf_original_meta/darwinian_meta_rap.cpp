...
#define RECOMBINATION 0.1//0.1 //(0.1)    // probability of recombining two output sequences; if not recombination, migration
#define MIGRATION     0.004 //(0.004)   // probability of migration; only if DN > 1
#define MUTATION      1.0/(float)N//1.0/(float)N // per-bit mutation rate of re-entered output of previous generation
