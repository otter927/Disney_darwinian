...
#define N           30//20//10  // number of neurons (200) // if Nk landscape is used, the maximal value of N is 63!
...
#define NN       100//100      // population size of a deme (number of networks)
