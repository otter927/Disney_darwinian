...
position_file2 = "data/position07.csv"
...
sim.execute_DRL_mobility(position_list1)
...
for i in range(17000):
    ...
    if (i<14000):
        if ((i // 1000) % 2 == 0):
            ...
            print("task2:"+str(i))
            sim.execute_DRL_mobility(position_list2)        
    else:                    
        print("task3:"+str(i))
        sim.execute_DRL_mobility(position_list3)
