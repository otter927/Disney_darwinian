...
class Simulator():
    ...
    def __init__(self, mode):
        ...
        #out_ul_random = open('ul_random.csv', 'w', newline='')
        #out_ul_random_writer = csv.writer(out_ul_random)
        #out_ul_random_writer.writerows(self.ul_random)

        #out_dl_random = open('dl_random.csv', 'w', newline='')
        #out_dl_random_writer = csv.writer(out_dl_random)
        #out_dl_random_writer.writerows(self.dl_random)
...
#######################
    def execute_sim_darwinian(self, position_list):
        ...
        print("ue_list length:"+str(len(self.UE_list)))
