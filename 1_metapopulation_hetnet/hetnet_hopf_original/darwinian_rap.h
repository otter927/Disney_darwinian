...
#define N           16//20//10  // number of neurons (200) // if Nk landscape is used, the maximal value of N is 63!
...
#define NN       10//100      // population size of a deme (number of networks)
...
typedef struct DEME {
  float w[NN], minW, maxW, avgW, input_t[NN][N], output[NN][N], test[NN][N], maxOutput[N], weight[NN][N][N], versatility[NN*NN][N];
