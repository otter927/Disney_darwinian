...
Simulator::Simulator(vector<double> position_list){
        ...
        double lamda = 10.0; //0.5, 1.0; 10.0; //0.1, 0.3, 0.5
...
double Simulator::execute_sim_darwinian(vector<double> position_list){
        ...
        #ifdef DEBUG
        cout << "!HetNet_toc_Sim execute_sim_darwinian1\n";
        #endif // DEBUG
        ...
        #ifdef DEBUG
        cout << "!HetNet_toc_Sim execute_sim_darwinian2\n";
        #endif // DEBUG
        ...
        #ifdef DEBUG
        cout << "!HetNet_toc_Sim execute_sim_darwinian3\n";
        #endif // DEBUG
        ...
        //for o_env, output in enumerate(deme_list):
            ...
            for (UE *ue : UE_list){
                (*ue).cp_data_list();
                #ifdef DEBUG
                cout << "!HetNet_toc_Sim execute_sim_darwinian30\n";
            ...
            #ifdef DEBUG
            cout << "!HetNet_toc_Sim execute_sim_darwinian31\n";
            #endif // DEBUG
            ...
            for (int j=0; j< 10; j++){
                ...
                for (BS *bs : BS_list){
                    ...
                    #ifdef DEBUG
                    cout << "!HetNet_toc_Sim execute_sim_darwinian321\n";
                ...
                #ifdef DEBUG
                cout << "!HetNet_toc_Sim execute_sim_darwinian311\n";
                #endif // DEBUG
                ...
                #ifdef DEBUG
                for (Link *i: Link_list){
                    cout << "!HetNet_toc_Sim execute_sim_darwinian31211\n";
                    printf("capacity:%e, %d\n", (*i).get_capacity(), (*i).id);
                }
                #endif // DEBUG
                ...
                #ifdef DEBUG
                cout << "!HetNet_toc_Sim execute_sim_darwinian312\n";
                #endif // DEBUG

                for (UE *ue: UE_list){
                    #ifdef DEBUG
                    cout << "!HetNet_toc_Sim execute_sim_darwinian3121\n";
                    printf("(*ue).data_list.size():%d\n", (*ue).data_list.size());
                    printf("(*ue).data_list_copy.size():%d\n", (*ue).data_list_copy.size());
                    #endif // DEBUG
                ...
                #ifdef DEBUG
                cout << "!HetNet_toc_Sim execute_sim_darwinian3122\n";
                for (BS *bs: BS_list){
            ...
            #ifdef DEBUG
            cout << "!HetNet_toc_Sim execute_sim_darwinian32\n";
            #endif // DEBUG
        ...
        #ifdef DEBUG
        cout << "!HetNet_toc_Sim execute_sim_darwinian4\n";
        #endif // DEBUG
        ...
        //for o_env, output in enumerate([deme_list[0], deme_list[1]]):
            ...
            for (int j=0; j<10; j++){
                ...
                for (BS *bs : BS_list){
                    ...
                    #ifdef DEBUG
                    cout << "!HetNet_toc_Sim execute_sim_darwinian40\n";
                    printf("id state timestep %d, %d, %d\n", (*bs).id, (*bs).get_state(), time_step);
                    #endif // DEBUG
                    //#for i in self.BS_list:
                    //#    i.set_state(self.time_slot)
                ...
                #ifdef DEBUG
                for (Link *i: Link_list){
                    cout << "!HetNet_toc_Sim execute_sim_darwinian401\n";
                    printf("capacity:%e, %d\n", (*i).get_capacity(), (*i).id);
                }
                #endif // DEBUG
               ...
               for (UE *ue : UE_list){
                    #ifdef DEBUG
                    cout << "!HetNet_toc_Sim execute_sim_darwinian41\n";
                    printf("(*ue).data_list.size():%d\n", (*ue).data_list.size());
                    #endif // DEBUG
                    (*ue).recieve_test(time_slot);
                }
        ...
        #ifdef DEBUG
        cout << "!HetNet_toc_Sim execute_sim_darwinian5\n";
        #endif // DEBUG
        ...
        for (int j=0; j< 10; j++){
            ...
            for (BS *bs : BS_list){
                ...
                #ifdef DEBUG
                cout << "!HetNet_toc_Sim execute_sim_darwinian61\n";
                printf("id state timestep %d, %d, %d\n", (*bs).id, (*bs).get_state(), time_step);
                #endif // DEBUG
            }                    
            ...
            #ifdef DEBUG
            for (Link *i: Link_list){
                cout << "!HetNet_toc_Sim execute_sim_darwinian611\n";
                printf("capacity:%e, %d\n", (*i).get_capacity(), (*i).id);
            }
            #endif // DEBUG
            ...
            for (UE *ue : UE_list){
                #ifdef DEBUG
                cout << "!HetNet_toc_Sim execute_sim_darwinian51\n";
                printf("(*ue).data_list.size():%d\n", (*ue).data_list.size());
                #endif // DEBUG
        ...
        #ifdef DEBUG
        cout << "!HetNet_toc_Sim execute_sim_darwinian6\n";
        #endif // DEBUG
        ...
        #ifdef DEBUG
        cout << "!HetNet_toc_Sim execute_sim_darwinian7\n";
        #endif // DEBUG
        ...
        if (true){
            ...
            for (UE *ue : UE_list){
                ...
                #ifdef DEBUG
                cout << "!HetNet_toc_Sim execute_sim_darwinian71\n";
                #endif // DEBUG
                ...
                if (old_bs != new_bs){
                    ...
                    #ifdef DEBUG
                    cout << "!HetNet_toc_Sim execute_sim_darwinian710\n";
                    ...
                    #ifdef DEBUG
                    cout << "!HetNet_toc_Sim execute_sim_darwinian711\n";
                    printf("BS id: %d", (*old_bs).id);
                    #endif // DEBUG

                    vector<UE *> UE_tmp = (*old_bs).get_connecting_UE_ul();
                    #ifdef DEBUG
                    cout << "!HetNet_toc_Sim execute_sim_darwinian712\n";
                    #endif // DEBUG
                    bool UE_bool = false;
                    for(auto iter = UE_tmp.begin(); iter != UE_tmp.end(); ++iter){
                        #ifdef DEBUG
                        cout << "!HetNet_toc_Sim execute_sim_darwinian713\n";
                        #endif // DEBUG
                        if((*(*iter)).id == (*ue).id){
                            UE_bool = true;
                        }
                    ...
                    #ifdef DEBUG
                    cout << "!HetNet_toc_Sim execute_sim_darwinian72\n";
                    #endif // DEBUG
                    ...
                    #ifdef DEBUG
                    cout << "!HetNet_toc_Sim execute_sim_darwinian73\n";
                    #endif // DEBUG
                    ...
                    #ifdef DEBUG
                    cout << "!HetNet_toc_Sim execute_sim_darwinian74\n";
                    #endif // DEBUG
        ...
        #ifdef DEBUG
        cout << "!HetNet_toc_Sim execute_sim_darwinian8\n";
        printf("UE_list: %d\n", UE_list.size());
        #endif // DEBUG
        ...
        for (UE *ue : UE_list){    
            #ifdef DEBUG
            cout << "!HetNet_toc_Sim execute_sim_darwinian81\n";
            #endif // DEBUG
            (*ue).gen_random_data_ue(time_step / 10);  //#gen random data
            #ifdef DEBUG
            cout << "!HetNet_toc_Sim execute_sim_darwinian82\n";
            printf("(*ue).data_list.size():%d\n", (*ue).data_list.size());
            #endif // DEBUG
        }
        
        #ifdef DEBUG
        cout << "!HetNet_toc_Sim execute_sim_darwinian9\n";
        #endif // DEBUG
        ...
        #ifdef DEBUG
        cout << "!HetNet_toc_Sim execute_sim_darwinian10\n";
        #endif // DEBUG
...
void Simulator::move_file(vector<double> position_list){
        ...
        for (int i=0; i< 100; i++){
            if ((i % 2 == 0) && (i/2 < UE_list.size())){
                ...
                (*UE_list[i / 2]).set_xaxis(position_list[i]);
                (*UE_list[i / 2]).set_yaxis(position_list[i+1]);
            }
        }
}
...
//            printf("throughput: %f, %f, %f\n", throughput_ul_list[len/4], throughput_ul_list[len/2], throughput_ul_list[len*3/4]);
        ...
        if (!throughput_dl_sbs_list.empty()){
            ...
            printf("throughput_dl_sbs: %f, %f, %f, ", throughput_dl_sbs_list[len/4], throughput_dl_sbs_list[len/2], throughput_dl_sbs_list[len*3/4]);
        }
        else{
            printf("throughput_dl_sbs: %f, %f, %f, ", 0.0, 0.0, 0.0);        
        }
